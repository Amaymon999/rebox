...
## Evento apertura (live-ready)

La home include una hero principale per i **primi 3 giorni di apertura**:

- Giorno 1: iPhone 17 Pro arancio + 1 iPad (premi nascosti)
- Giorno 2: 1 iPad
- Giorno 3: 1 iPad

La comunicazione è trasparente: premi indicati come nascosti nei box con disponibilità reale dei drop.
